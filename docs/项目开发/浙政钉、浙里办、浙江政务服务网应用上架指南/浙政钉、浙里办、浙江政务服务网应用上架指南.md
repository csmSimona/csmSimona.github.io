...
```javascript 
export const LOGIN_LINK = `https://portal.zjzwfw.gov.cn/uc/sso/login?appId=XXX&sp=${encodeURIComponent(window.location.href.split('#')[0])}`;
